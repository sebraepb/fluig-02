function createDataset(fields, constraints, sortFields) {
    ...
    try{
		...
		var result = authService.realizarConsultaSQL("Fluig.SQL.06", 1 , "T", "CODACAO="+filtro);	
