function createDataset(fields, constraints, sortFields) {
    ...
    try{
		...
		var result = authService.realizarConsultaSQL("Fluig.SQL.05", 1 , "T", "CODPROJETO="+filtro);	
		...
		for each(consql in xmlResultados.Resultado) {
			dataset.addRow(new Array(
					...
					consql.ACAO.toString(),
					consql.CODPROJETOACAO.toString(),
					consql.UNIDADE.toString(),
					consql.CODUNIDADE.toString()
			));        
		}
